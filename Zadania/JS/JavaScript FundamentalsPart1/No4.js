...
Your tasks:
1. Calculate the tip, depending on bind value. Create Variable Called Tip For this. It's not allowed to use an if/else statement 😅 
...
console.log(`You should give a ${billValue >= 50 && billValue <= 300 ? billValue * 0.15 : billValue * 0.2}$ tip`)