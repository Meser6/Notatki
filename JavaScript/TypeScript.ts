...
przykladFunkcji3(1, 2, 3); // mozemy za to wyslac wiele argumentow gdy okreslimy je w ten sposob
...
interface wzorObiektu {
  // mozemy stoworzyc interfejs ktoty jest wzornikiem
...
const enumy = (marka: markiSaamochodow) => {
  console.log(marka);
};
