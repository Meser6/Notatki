...
//dopisywanie typu
{
  ...
  przykladZmiennnej = "15"; //blad// dzieku temu do danej zmiennej nie bedziemy mogli wrzucic innych typow
  ...
  //Automatyczne dopisywanie
  {
    ...
    toBedzieNumer = "216"; //blad// nie pozwoli dopisac czegos innego pomimo braku widocznej deklaracji
  ...
  //Wiele typow
  {
    ...
    dwaTypy = 2;
    dwaTypy = "2";
    dwaTypy = true; //blad// true nie mozemy przypisac bo zawezilismy tylko do numberow i stringow
  }
  //Dokładne wartosci
  {
    ...
    siedemLubOsiem = 7;
    siedemLubOsiem = 8;
    siedemLubOsiem = 9; //blad//  9 nie mozemy przypisac bo zawezilismy tylko do 7 i 8
  }
}
//wymuszanie zgodnosci
{
  //wymuszanie zgodnosci stosujemy wszedzie tam gdzie TS nie moze się domyślić z kodu co dotanie (np z HTMLA lub z API)
  //ale my mamy pewność, że dostanie dokladnie to podamy
  ...
  elmentLubNull.value; //blad// TS nie wie czy bedzie element czy null
  ...
  elemnt.value; //blad// nie pozwoli nam jednak pobrac wartosci poniewaz nie wie jaki dokladnie typ elementu zostanie zwrocony (nie kazdy ma value)
